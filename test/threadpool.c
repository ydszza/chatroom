...
int threadpool_add_job(struct threadpool* pool, void* (*callback_function)(void *arg), void *arg)
{
    ...
    while ((pool->queue_cur_num == pool->queue_max_num) && !(pool->queue_close || pool->pool_close))//当前队列未满 线程池和队列未关闭
    {
...
/**
 * 原文章：https://www.cnblogs.com/venow/archive/2012/11/22/2779667.html
 * 带测试的demo：https://blog.csdn.net/guotianqing/article/details/88929210
*/