...
QT_MOC_LITERAL(1, 5, 20), // "signal_home_send_msg"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 8), // "QString*"
QT_MOC_LITERAL(4, 36, 25), // "slot_add_or_out_newclient"
QT_MOC_LITERAL(5, 62, 6), // "msg_t*"
QT_MOC_LITERAL(6, 69, 16), // "slot_get_new_msg"
QT_MOC_LITERAL(7, 86, 13) // "slot_send_msg"

    },
    "home\0signal_home_send_msg\0\0QString*\0"
    "slot_add_or_out_newclient\0msg_t*\0"
    "slot_get_new_msg\0slot_send_msg"
};
...
void home::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->signal_home_send_msg((*reinterpret_cast< QString*(*)>(_a[1]))); break;
        case 1: _t->slot_add_or_out_newclient((*reinterpret_cast< msg_t*(*)>(_a[1]))); break;
        case 2: _t->slot_get_new_msg((*reinterpret_cast< msg_t*(*)>(_a[1]))); break;
        case 3: _t->slot_send_msg((*reinterpret_cast< QString*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (home::*_t)(QString * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&home::signal_home_send_msg)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void home::signal_home_send_msg(QString * _t1)
{
